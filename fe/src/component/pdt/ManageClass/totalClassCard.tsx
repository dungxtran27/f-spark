  ...
  return (
    <>
      ...
      <div className="bg-white p-4 shadow-md rounded-md border-2 border-transparent hover:border-orange-400">
        ...
        <div className="text-lg font-semibold "> Total Groups: {groupsData?.data?.data.totalGroup} groups</div>
        <hr className="my-2" />
        {isStudentOpen && (
          <>
            <div
            ...
            >
              <span>Groups not have class: {groupsData?.data?.data.countGroupNotHaveClass}</span>
            ...
            >
              <span>Students not have class: {studentsData?.data?.data.countStudentNotHaveClass}</span>
